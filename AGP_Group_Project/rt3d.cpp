...
//void setSpotLight(const GLuint program, const lightStruct light, glm::vec3 direction) {
//	// pass in light data to shader
//	int uniformIndex = glGetUniformLocation(program, "spotLight.ambient");
//	glUniform4fv(uniformIndex, 1, light.ambient);
//	uniformIndex = glGetUniformLocation(program, "spotLight.diffuse");
//	glUniform4fv(uniformIndex, 1, light.diffuse);
//	uniformIndex = glGetUniformLocation(program, "spotLight.specular");
//	glUniform4fv(uniformIndex, 1, light.specular);
//	uniformIndex = glGetUniformLocation(program, "spotLightPosition");
//	glUniform4fv(uniformIndex, 1, light.position);
//}
